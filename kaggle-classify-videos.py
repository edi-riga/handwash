...
data_dir = 'dataset-kaggle/kaggle-dataset-6classes-preprocessed/frames/trainval'
test_data_dir = 'dataset-kaggle/kaggle-dataset-6classes-preprocessed/frames/test'
